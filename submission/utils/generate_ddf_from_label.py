...
class generate_ddf_from_label:
    ...
    def __init__(self, data_path_calib):
        ...
        self.tform_calib_scale, self.tform_calib_R_T, self.tform_calib = (
            read_calib_matrices(
                os.path.join(
                    os.path.dirname(os.path.realpath(__file__)), data_path_calib
                )
            )
        )
        self.tform_calib_scale, self.tform_calib_R_T, self.tform_calib = (
