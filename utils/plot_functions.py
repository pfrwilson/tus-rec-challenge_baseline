...
def read_calib_matrices(filename_calib):
    ...
    return (
        torch.tensor(tform_calib[0:4, :], dtype=torch.float32),
        torch.tensor(tform_calib[4:8, :], dtype=torch.float32),
        torch.tensor(tform_calib[4:8, :] @ tform_calib[0:4, :], dtype=torch.float32),
    )
